...
```bash
ruby trading/dhanhq/dhanhq_agent.rb
```
...
# With custom query
ruby trading/dhanhq/technical_analysis_runner.rb "Find options opportunities for NIFTY"

# With custom query and market context
ruby trading/dhanhq/technical_analysis_runner.rb "Analyze banking stocks" "Banking sector showing strength"

# Show manual examples too (for comparison)
SHOW_MANUAL_EXAMPLES=true ruby trading/dhanhq/technical_analysis_runner.rb
```
